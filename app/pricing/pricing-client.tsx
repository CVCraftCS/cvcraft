      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        ...
        <header className="text-center">
          ...
          <p className="mt-4 text-lg text-white/70">
            Everything you need to create a professional CV fast — with one simple
            payment.
          </p>
        </header>
        ...
        <section className="mx-auto mt-10 max-w-4xl rounded-2xl border border-white/10 bg-white/5 p-8 shadow-lg">
          <h3 className="text-xl font-semibold">
            Built for real job-search timelines
          </h3>
          <p className="mt-3 text-white/70">
            Most people don’t need a CV tool every month — they need it when
            applying, interviewing, and improving.
          </p>
          <p className="mt-3 text-white/70">
            <span className="font-medium text-white">
              CVCraft is pay-once, use-when-needed.
            </span>
          </p>
          <p className="mt-3 text-white/70">
            Most CV builders renew monthly. We don’t.
          </p>
        </section>
          ...
          <div className="mt-5 space-y-5">
            <div>
              ...
              <p className="mt-1 text-white/70">
                No. You pay once for 30 days of full access.
              </p>
            </div>

            <div>
              <p className="font-medium text-white">
                What do I get in the 30 days?
              </p>
              <p className="mt-1 text-white/70">
                Unlimited edits, templates, PDF exports, region presets — and a
            ...
            <div>
              <p className="font-medium text-white">
                Can I download my CV during access?
              </p>
              <p className="mt-1 text-white/70">
                Yes — download as many times as you like while your access is
                active.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-white/70">
                If you haven’t exported a CV, you can request a refund within 24
                hours. Once exported, the service has been delivered.
              </p>
            </div>
          </div>
        </section>
