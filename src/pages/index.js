            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <div className="mt-5 flex flex-col sm:flex-row gap-3">
                  ...
                  {/* ✅ NEW: Template page CTA (internal linking) */}
                  <Link
                    href="/cv-template-uk"
                    className="inline-flex items-center justify-center rounded-2xl bg-white/5 ring-1 ring-white/10 px-5 py-3 text-sm font-semibold text-white hover:bg-white/10 transition"
                  >
            ...
            <section className="mt-16">
              <div className="rounded-3xl bg-white/5 p-8 ring-1 ring-white/10">
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  {/* ✅ NEW: UK template link card */}
                  <Link
                    href="/cv-template-uk"
                    className="rounded-2xl bg-emerald-500/10 p-5 ring-1 ring-emerald-400/20 hover:bg-emerald-500/15 transition"
                  >
                    <div className="text-sm font-semibold text-white">
                      UK CV template (free structure)
                    </div>
                    <div className="mt-1 text-sm text-slate-200">
                      Clean layout + section order you can copy.
                    </div>
                  </Link>

                  <Link
                    href="/cv-examples-uk"
                    className="rounded-2xl bg-white/5 p-5 ring-1 ring-white/10 hover:bg-white/10 transition sm:col-span-2 lg:col-span-2"
                  >
                    <div className="text-sm font-semibold text-white">
                      CV Examples UK (2026)
                    </div>
